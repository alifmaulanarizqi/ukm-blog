        ...
        <div class="col-lg-5 mx-auto my-auto">
          <div class="card shadow">
            <div class="card-body px-5 py-4 form-text">
              <h4 class="mb-5 font-weight-bold">Forgot Password</h4>
              <form action="{{ route('password.email') }}" method="post" class="">
                @csrf
                <div class="form-group">
                  Lupa password? Tenang saja. Masukan email Anda dan kami akan kirimkan email yang berisi link reset password
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary btn-block mt-4 py-2" type="submit">Kirim Link Reset Password</button>
                  </div>
              </form>
            </div>
          </div>
